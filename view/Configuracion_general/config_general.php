	...
	<div class="page-content">
		<div class="container-fluid">
			<section class="card">
                ...
                <form method="post" id="configGeneral_form" enctype="multipart/form-data">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="card" style="width: 18rem;">
                                            <img id= "Logo" src="" alt="Imagen" class="img-fluid">
                                            <div class="card-body">
                                                <input class="form-control" name="Logo" type="file" id="formFile" accept="image/*">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-12">
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                    <br>
                                    <button type="button" name="action" id="btnMagistrado" class="btn btn-inline btn-secondary glyphicon glyphicon-search" value ="user_presidencia"> Buscar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-12">
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                    <br>
                                    <button type="button" name="action" id="btnMagistrado" class="btn btn-inline btn-secondary glyphicon glyphicon-search" value ="user_archivo"> Buscar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-12">
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                    <br>
                                    <button type="button" name="action" id="btnMagistrado" class="btn btn-inline btn-secondary glyphicon glyphicon-search" value ="user_uaa"> Buscar</button>
                                    </div>
                                </div>
                            </di>
                        </div>
