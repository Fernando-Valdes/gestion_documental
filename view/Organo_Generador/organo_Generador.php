...
<html>
	...
	<title>Administración de Organo Generador</title>
</head>
<body class="with-side-menu">
					...
					<table id="Subfondo_data" class="table table-bordered table-striped table-vcenter js-dataTable-full">
						<thead>
							<tr>
								...
								<th style="width: 3%;">Seccion</th>
								<th style="width: 15%;">Organo Generador</th>
	...
	<?php require_once("ModalOrganoGenerador.php");?>

	<?php require_once("../MainJs/js.php");?>
	
	<script type="text/javascript" src="organo_Generador.js"></script>
